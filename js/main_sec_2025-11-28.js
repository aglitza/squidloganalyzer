 ...
 */
        ...
        const chartDomainUsageXDaysLabels = chartDomainUsageXDaysData.map(row => `${row.day} - ${row.domain}`);
        const chartDUXDaysData = chartDomainUsageXDaysData.map(row => row.hits);
